...
IMAGE_PATH = 'graphics/snail_explosion.png'
...
class SnailExplosion(Sprite):
    ...
    def __init__(self, position):
        ...
        if IMAGE_PATH not in SnailExplosion.image_cache:
            sprite_sheet = pygame.image.load(IMAGE_PATH).convert_alpha()
            SnailExplosion.image_cache[IMAGE_PATH] = sprite_sheet
    ...
    def _generate_frames(self):
        ...
        frames = []
        sprite_sheet = SnailExplosion.image_cache[IMAGE_PATH]
